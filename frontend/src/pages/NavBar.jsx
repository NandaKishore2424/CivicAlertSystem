...
export default function Navbar() {
  ...
  return (
    <nav
      className={`fixed top-0 left-0 w-full z-50 transition-all duration-300 ${isScrolled ? "bg-slate-900 shadow-md py-2" : "bg-slate-900/95 py-2"}`}
    >
          ...
          <Link to="/" className="hidden md:flex items-center">
            <div className="flex flex-col items-start">
              <span className="text-2xl font-bold tracking-tight">
                ...
                <span className="bg-gradient-to-r from-red-500 to-red-300 text-transparent bg-clip-text font-light ml-1">
                  ALERT-SYSTEM
                </span>
              </span>
